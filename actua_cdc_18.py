...
if not os.path.exists(fich1_path):
    ...
    try:
        ...
        df = pd.read_csv(fich1_path, sep=';', encoding='latin1', header=None)

        # Renombra las columnas
        df.columns = ['EAN', 'STOCK', 'CODIGOARTICULO', 'DESCRIPCION', 'TALLA', 'FAMILIA', 'ALMACEN', 'ESOUTLET', 'PVR', 'URL_IMAGEN']
